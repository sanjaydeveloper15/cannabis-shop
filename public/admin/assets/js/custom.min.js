...
$('[data-toggle="offcanvas"]').on('click', function () {
    ...
    $('.offcanvas-collapse, .offcanvas-sidebar').toggleClass('open');
});
$('.closeIcon').click(function(){
    $(this).parent('.offcanvas-sidebar').toggleClass('open');
    // alert('sdgfsgs');
})
...
$('.radio-tabs input[type="radio"], .schedules-radio input[type="radio"]').click(function(){
    var inputValue = $(this).data("target");
...
function toggleBackToTopBtn() {
    ...
    $("a.close-menu, a.under-layer").click(function () {
        var myelement = $(this).attr("href")
        $(myelement).toggleClass("open"); 
    });
...
// aos animation
    ...
    $(window).on("scroll", function() {
        ...
        function stickyMenu() {
            ...
            var mainMenuTop = $('.site-header .navbar');

            if ($(window).scrollTop() > 100) {
                if (st > lastScrollTop) {
                    //to hide sticky menu on scroll down addClass replace to removeclass
                    mainMenuTop.addClass("sticky-on");

                } else {
                    // active sticky menu on scroll up
                    mainMenuTop.removeClass("sticky-on");
                }
    ...
    function c(passed_month, passed_year, calNum) {
        ...
        while (!u) {
            if (daysArray[r] == calMonthArray[0].weekday) {
                ...
                calendar.datesBody.append('<div class="blank"><span></span></div>');
                r++;
            }
        }
        for (var cell = 0; cell < 42 - r; cell++) { // 42 date-cells in calendar
            if (cell >= calMonthArray.length) {
                ...
                (shownDate != today.getDate() && passed_month == today.getMonth()) || passed_month != today.getMonth()) && iter_date < today) {
                    ...
                    var m = checkToday(iter_date) ? '<div class="today"><span>' : "</span><div>";
                }
